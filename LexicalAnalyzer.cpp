...
static string token_names[] = {"{}", "IDENT_T", "NUMLIT_T", "STRLIT_T", "CONS_T", "IF_T", "COND_T", 
			...
			"STRINGP_T", "MODULO_T", "PLUS_T", "MINUS_T", "DIV_T", "MULT_T", 
...
//	  a   c   d   r   b   0   .   (   )   +   -   *   /   '   =   <   >   ?   _   "  other
	...
	{ 8,  8, 11, 20,  8,  8, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21,  8, 21, 21},  // 10 letter a after c
	{ 8,  8, 11, 20,  8,  8, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21,  8, 21, 21},  // 11 letter d after c, ca, or cd...
	{12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 25, 12}}; // 12 character after "

/*******************************************************************************
* Function: LexicalAnalyzer(char * filename)                                   *
*                                                                              *
* Parameters: char*                                                            *
* Return value: none                                                           *
* Description: This function will create a LexicalAnalyzer object and attempt  *
* 	       to open our given filename (.ss). If successful, the function   *
* 	       will also create a new file (.p2) and prepare to write to it.   *
*******************************************************************************/
...
LexicalAnalyzer::LexicalAnalyzer (char * filename)
{
	...
	symbols.insert (pair<string,token_type> ("symbol?", SYMBOLP_T));
	...
	symbols.insert (pair<string,token_type> ("'", QUOTE_T));
}
...
* Parameters: none                                                             *
* Return value: none                                                           *
* Description: This function will close any input/output streams before        *
* 	       deleting the LexicalAnalyzer object.                            *
*******************************************************************************/
...
* Description: This function will return the token_type of our current token.  *
*******************************************************************************/
...
/*******************************************************************************
* Function: GetTokenName(token_type t) const                                   *
*                                                                              *
* Parameters: enumerated token_type                                            *
* Return value: string object                                                  *
* Description: This function will return the string value associated with the  *
* 	       token_type object. It uses the class-defined array token_names  *
* 	       to lookup the specific name.                                    *
*******************************************************************************/
...
/*******************************************************************************
* Function: GetLexeme() const                                                  *
*                                                                              *
* Parameters: none                                                             *
* Return value: string object                                                  *
* Description: This function will return a string of characters from our test  *
* 	       file that were responsible for creating our current token.      *
*******************************************************************************/
...
/*******************************************************************************
* Function: ReportError(const string & msg)                                    *
*                                                                              *
* Parameters: const string reference                                           *
* Return value: none                                                           *
* Description: This function will report an error message to our listing and   *
* 	       debug files, as well as increment our error counter.            *
*******************************************************************************/
